...
[NOTE]
====
External storage requires Hibernate ORM to be enabled in your Quarkus application.
The extension automatically creates the required database table (`jobrunr_control_parameter_sets`).
====
