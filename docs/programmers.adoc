...
[TIP]
====
For a complete sample, see the example module classes `jobrunr-control-example/src/main/java/ch/css/jobrunr/control/jobs/complex/ComplexParameterDemoJob.java`,
`ComplexParameterDemoChildJob.java`, `ComplexParameterDemoJobRecap.java`, `ComplexDemoMessageProvider.java`, and `ComplexDemoRecapProvider.java`.
====
