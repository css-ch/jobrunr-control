...
@JobParameterSet({
    ...
    @JobParameterDefinition(name = "batchSize", required = false, type = "java.lang.Integer", defaultValue = "1000"),
    @JobParameterDefinition(name = "mode", required = false, type = "com.example.Mode", defaultValue = "STANDARD")
})
